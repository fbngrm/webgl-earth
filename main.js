...
initScene = function() {
    ...
    this.nightTexture = new Texture2D(gl, "textures/test_world_texture.gif", this);
    ...
    // planet earth
    this.world = new Sphere(gl, 0.5, 75, 75);
    
    // material for the earth
    this.earthMaterial = new Material([0.1, 0.3, 0.4], [0.3, 0.4, 0.0], [0.3, 0.3, 0.3], 200);
}
...
drawScene = function() {
    ...
    // activate the earth texture
    this.daylightTexture.makeActive(program, "earthSurface", 0);
    this.nightTexture.makeActive(program, "nightSurface", 1);
...
updateMonth = function() {
    ...
    theScene.daylightTexture= new Texture2D(theScene.getGL(), 
                                             "textures/month"+monthId+".jpg", 
                                             theScene                        );
